...
export class MyApp {
    ...
    constructor(platform: Platform, private menuCtrl: MenuController, private authService: AuthService) {
        var config = {
            apiKey: "AIzaSyD8GLGtvthDIwgCEFErnLcjPEWdWXBUVfc",
            authDomain: "weathersight-76387.firebaseapp.com",
            databaseURL: "https://weathersight-76387.firebaseio.com",
            storageBucket: "weathersight-76387.appspot.com",
            messagingSenderId: "195269835296"
        };
